...
APP_NAME="filezilla"
IMAGE_NAME="filezilla-mac:latest"
CONTAINER_NAME="filezilla-MAC"
APP_PORT=5801
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[FILEZILLA]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Filezilla Docker image..."
    ...
    log_success "Filezilla image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Filezilla container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://upload.wikimedia.org/wikipedia/commons/0/01/FileZilla_logo.svg" \
    ...
    log_success "Filezilla container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Filezilla information in Vault..."
...
# Main
main() {
    log_info "Starting Filezilla deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Filezilla deployment complete!"
