#!/bin/bash
# ============================================================================
# HOMEASSISTANT DEPLOYMENT SCRIPT
# ============================================================================
...
IMAGE_NAME="homeassistant-mac:latest"
CONTAINER_NAME="homeassistant-MAC"
APP_PORT=8123
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[HOMEASSISTANT]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Homeassistant Docker image..."
    ...
    log_success "Homeassistant image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Homeassistant container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://upload.wikimedia.org/wikipedia/commons/6/6e/Home_Assistant_Logo.svg" \
    ...
    log_success "Homeassistant container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Homeassistant information in Vault..."
...
# Main
main() {
    log_info "Starting Homeassistant deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Homeassistant deployment complete!"
