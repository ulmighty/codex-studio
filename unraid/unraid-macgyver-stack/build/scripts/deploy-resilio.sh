...
APP_NAME="resilio"
IMAGE_NAME="resilio-mac:latest"
CONTAINER_NAME="resilio-MAC"
APP_PORT=8889
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[RESILIO]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Resilio Docker image..."
    ...
    log_success "Resilio image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Resilio container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://www.resilio.com/wp-content/uploads/2019/05/resilio-sync-logo.png" \
    ...
    log_success "Resilio container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Resilio information in Vault..."
...
# Main
main() {
    log_info "Starting Resilio deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Resilio deployment complete!"
