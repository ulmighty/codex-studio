#!/bin/bash
# ============================================================================
# NGINX-PROXY-MANAGER DEPLOYMENT SCRIPT
# ============================================================================
...
IMAGE_NAME="nginx-proxy-manager-mac:latest"
CONTAINER_NAME="nginx-proxy-manager-MAC"
APP_PORT=81
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[NGINX-PROXY-MANAGER]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Nginx-proxy-manager Docker image..."
    ...
    log_success "Nginx-proxy-manager image built successfully"
}
...
deploy_app() {
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://dashboardicons.com/assets/img/icons/nginx-proxy-manager.png" \
    ...
    log_success "Nginx-proxy-manager container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Nginx-proxy-manager information in Vault..."
...
# Main
main() {
    log_info "Starting Nginx-proxy-manager deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Nginx-proxy-manager deployment complete!"
