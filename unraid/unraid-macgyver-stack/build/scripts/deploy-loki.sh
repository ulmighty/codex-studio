...
APP_NAME="loki"
IMAGE_NAME="loki-mac:latest"
CONTAINER_NAME="loki-MAC"
APP_PORT=3100
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[LOKI]\033[0m $1"
}
...
build_app() {
    ...
    log_success "Loki image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Loki container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://grafana.com/static/assets/img/logos/loki.png" \
    ...
    log_success "Loki container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Loki information in Vault..."
...
# Main
main() {
    log_info "Starting Loki deployment..."
