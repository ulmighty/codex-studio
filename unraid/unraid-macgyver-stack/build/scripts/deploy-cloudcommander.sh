#!/bin/bash
# ============================================================================
# CLOUDCOMMANDER DEPLOYMENT SCRIPT
# ============================================================================
...
APP_NAME="cloudcommander"
IMAGE_NAME="cloudcommander-mac:latest"
CONTAINER_NAME="cloudcommander-MAC"
APP_PORT=8000
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[CLOUDCOMMANDER]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Cloudcommander Docker image..."
    ...
    log_success "Cloudcommander image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Cloudcommander container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://cloudcmd.io/img/logo/cloudcmd.svg" \
    ...
    log_success "Cloudcommander container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Cloudcommander information in Vault..."
...
# Main
main() {
    log_info "Starting Cloudcommander deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Cloudcommander deployment complete!"
