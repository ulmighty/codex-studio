...
APP_NAME="homebox"
IMAGE_NAME="homebox-mac:latest"
CONTAINER_NAME="homebox-MAC"
APP_PORT=7745
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[HOMEBOX]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Homebox Docker image..."
    ...
    log_success "Homebox image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Homebox container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://raw.githubusercontent.com/hay-kot/homebox/main/frontend/public/logo.png" \
    ...
    log_success "Homebox container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Homebox information in Vault..."
...
# Main
main() {
    log_info "Starting Homebox deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Homebox deployment complete!"
