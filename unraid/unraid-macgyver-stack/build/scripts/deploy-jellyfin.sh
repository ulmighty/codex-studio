...
APP_NAME="jellyfin"
IMAGE_NAME="jellyfin-mac:latest"
CONTAINER_NAME="jellyfin-MAC"
APP_PORT=8096
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[JELLYFIN]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Jellyfin Docker image..."
    ...
    log_success "Jellyfin image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Jellyfin container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/jellyfin-logo.png" \
    ...
    log_success "Jellyfin container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Jellyfin information in Vault..."
...
# Main
main() {
    log_info "Starting Jellyfin deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Jellyfin deployment complete!"
