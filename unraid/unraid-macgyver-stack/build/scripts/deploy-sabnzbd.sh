...
APP_NAME="sabnzbd"
IMAGE_NAME="sabnzbd-mac:latest"
CONTAINER_NAME="sabnzbd-MAC"
APP_PORT=8080
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[SABNZBD]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Sabnzbd Docker image..."
    ...
    log_success "Sabnzbd image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Sabnzbd container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/sabnzbd-logo.png" \
    ...
    log_success "Sabnzbd container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Sabnzbd information in Vault..."
...
# Main
main() {
    log_info "Starting Sabnzbd deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Sabnzbd deployment complete!"
