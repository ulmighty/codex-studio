...
APP_NAME="grafana"
IMAGE_NAME="grafana-mac:latest"
CONTAINER_NAME="grafana-MAC"
APP_PORT=3000
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[GRAFANA]\033[0m $1"
}
...
deploy_app() {
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://seeklogo.com/images/G/grafana-logo-3A3D8C1A5C-seeklogo.com.png" \
    ...
    log_success "Grafana container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Grafana information in Vault..."
...
# Main
main() {
    log_info "Starting Grafana deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Grafana deployment complete!"
