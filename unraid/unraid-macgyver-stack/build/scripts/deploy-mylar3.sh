...
APP_NAME="mylar3"
IMAGE_NAME="mylar3-mac:latest"
CONTAINER_NAME="mylar3-MAC"
APP_PORT=8090
USE_VPN=true

log_info() {
    echo -e "\033[0;34m[MYLAR3]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Mylar3 Docker image..."
    ...
    log_success "Mylar3 image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Mylar3 container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/mylar3-logo.png" \
    ...
    log_success "Mylar3 container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Mylar3 information in Vault..."
...
# Main
main() {
    log_info "Starting Mylar3 deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Mylar3 deployment complete!"
