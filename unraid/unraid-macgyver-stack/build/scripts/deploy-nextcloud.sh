...
APP_NAME="nextcloud"
IMAGE_NAME="nextcloud-mac:latest"
CONTAINER_NAME="nextcloud-MAC"
APP_PORT=8081
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[NEXTCLOUD]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Nextcloud Docker image..."
    ...
    log_success "Nextcloud image built successfully"
}
...
deploy_app() {
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/nextcloud-logo.png" \
    ...
    log_success "Nextcloud container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Nextcloud information in Vault..."
...
# Main
main() {
    log_info "Starting Nextcloud deployment..."
