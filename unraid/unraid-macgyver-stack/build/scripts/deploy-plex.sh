...
APP_NAME="plex"
IMAGE_NAME="plex-mac:latest"
CONTAINER_NAME="plex-MAC"
APP_PORT=32400
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[PLEX]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Plex Docker image..."
    ...
    log_success "Plex image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Plex container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/plex-logo.png" \
    ...
    log_success "Plex container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Plex information in Vault..."
...
# Main
main() {
    log_info "Starting Plex deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Plex deployment complete!"
