...
APP_NAME="prometheus"
IMAGE_NAME="prometheus-mac:latest"
CONTAINER_NAME="prometheus-MAC"
APP_PORT=9090
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[PROMETHEUS]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Prometheus Docker image..."
...
deploy_app() {
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://seeklogo.com/images/P/prometheus-monitoring-system-logo-4077C6C3D5-seeklogo.com.png" \
    ...
    log_success "Prometheus container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Prometheus information in Vault..."
...
main() {
    ...
    log_success "Prometheus deployment complete!"
