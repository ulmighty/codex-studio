...
APP_NAME="notifiarr"
IMAGE_NAME="notifiarr-mac:latest"
CONTAINER_NAME="notifiarr-MAC"
APP_PORT=5454
USE_VPN=false

log_info() {
    echo -e "\033[0;34m[NOTIFIARR]\033[0m $1"
}
...
# Build image
build_app() {
    log_info "Building Notifiarr Docker image..."
    ...
    log_success "Notifiarr image built successfully"
}

# Deploy container
deploy_app() {
    log_info "Deploying Notifiarr container..."
    ...
    docker run -d \
        ...
        --label="net.unraid.docker.icon=https://avatars.githubusercontent.com/u/130932487?s=200&v=4" \
    ...
    log_success "Notifiarr container deployed"
}

# Store in Vault
store_in_vault() {
    log_info "Storing Notifiarr information in Vault..."
...
# Main
main() {
    log_info "Starting Notifiarr deployment..."
    
    build_app
    deploy_app
    store_in_vault
    
    log_success "Notifiarr deployment complete!"
